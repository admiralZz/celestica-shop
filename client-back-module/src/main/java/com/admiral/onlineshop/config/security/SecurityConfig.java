...
import com.admiral.onlineshop.config.security.filter.JwtTokenFilter;
...
//                        .requestMatchers("/api/orders/**").authenticated()
                ...
                // Добавляем JWT фильтр напрямую вместо использования JwtConfigurer
