...
import com.admiral.adminshop.database.repository.CategoryRepository;
import com.admiral.adminshop.database.repository.ProductRepository;
...
import com.admiral.adminshop.exception.CategoryNotFoundException;
import com.admiral.adminshop.mapper.ProductMapper;
...
public class ProductServiceImpl implements ProductService {
    ...
    public ProductDTO updateProduct(Long id, ProductUpdateDTO productUpdateDTO) {
        ...
        // Обновление картинки, если указана
        Optional.ofNullable(productUpdateDTO.getImage())
                .map(productImageService::upload)
